                ...
                <div class="container">
                    ...
                    <div style="text-align: center">
                        ...
                        <form action="" method="POST" >
                                <input  type='radio' name='bills'  value='Đen' checked />Thanh Toán Trực Tiêp
                                &nbsp;  &nbsp;     
                                <input type='radio' name='bills'  value='Đỏ' />Thanh Toán Qua App
                                &nbsp;  &nbsp;  
                                
                                <input type='radio' name='bills'  value='Trắng' />Thanh Toán Qua Thẻ Ngân Hàng
                        </form>
                    </div>
