<main class="ps-main">
			...
			<ul>
				<li class="ps-banner" data-hideafterloop="0" data-hideslideonmobile="off" data-index="rs-2972"
					data-rotate="0" data-slotamount="default" data-transition="random"><img alt="" class="rev-slidebg"
						...
						data-no-retina="" src="<?= CLIENT_ASSETS ?>images/slider/3.jpg" />
				...
				<li class="ps-banner ps-banner--white" data-hideafterloop="0" data-hideslideonmobile="off"
					data-index="rs-100" data-rotate="0" data-slotamount="default" data-transition="random"><img alt=""
						...
						data-bgrepeat="no-repeat" data-no-retina="" src="<?= CLIENT_ASSETS ?>images/slider/2.jpg" />
					<div class="tp-caption ps-banner__header"
						data-frames="[{&quot;delay&quot;:1000,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;x:50px;opacity:0;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power3.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:300,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;x:50px;opacity:0;&quot;,&quot;ease&quot;:&quot;Power3.easeInOut&quot;}]"
						data-hoffset="['-60','15','15','15']" data-responsive_offset="on" data-type="text"
						data-voffset="['-150','-120','-150','-170']" data-width="['none','none','none','400']"
	...
	<div class="ps-section--features-product ps-section masonry-root pt-100 pb-100">
		<div class="ps-container">
			<div class="ps-section__header mb-50">
				<h3 class="ps-section__title" data-mask="features">10 New Products</h3>
				...
				<div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30"
					...
					<div class="ps-masonry">
							...
							<div class="grid-item__content-wrapper">
								<div class="ps-shoe mb-30">
									<div class="ps-shoe__thumbnail">
										...
										<img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/1.jpg" />
									</div>

									<div class="ps-shoe__content">
										<div class="ps-shoe__variants">
											<div class="ps-shoe__variant normal"><img alt=""
													src="<?= CLIENT_ASSETS ?>images/shoe/2.jpg" /><img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/3.jpg" /><img
													alt="" src="<?= CLIENT_ASSETS ?>images/shoe/4.jpg" /><img alt=""
													src="<?= CLIENT_ASSETS ?>images/shoe/5.jpg" /></div>
						...
						<div class="grid-item nike">
							<div class="grid-item__content-wrapper">
								<div class="ps-shoe mb-30">
									<div class="ps-shoe__thumbnail"><img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/2.jpg" /></div>
									...
									<div class="ps-shoe__content">
										...
										<div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detail.php">Air Jordan 7
												Retro</a>

											<p class="ps-shoe__categories"><a href="product-detail.php">Men shoes</a>,<a href="#">
													Nike</a>,<a href="product-detail.php"> Jordan</a></p>
	...
	<div class="ps-section--offer">
		<div class="ps-column"><a class="ps-offer" href="product-listing.html"><img alt=""
					src="<?= CLIENT_ASSETS ?>images/banner/home-banner-1.png" /></a></div>

		<div class="ps-column"><a class="ps-offer" href="product-listing.html"><img alt=""
					src="<?= CLIENT_ASSETS ?>images/banner/home-banner-2.png" /></a></div>
	</div>
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
						<div class="ps-hotspot">
							<div class="ps-hotspot__content">
								<p class="heading"><a class="point first active" href="javascript:;">JUMP TO HEADER</a>
								</p>

								<p><a class="point first active" href="javascript:;">Dynamic Fit Collar en la zona del
										tobillo que une la parte inferior de la pierna y el pie sin reducir la libertad
										de movimiento.</a></p>
							</div>
							...
							<div class="ps-hotspot__content">
								...
								<p><a class="point second" href="javascript:;">Dynamic Fit Collar en la zona del tobillo
										que une la parte inferior de la pierna y el pie sin reducir la libertad de
										movimiento.</a></p>
							</div>
							...
							<div class="ps-hotspot__content">
								...
								<p><a class="point third" href="javascript:;">Dynamic Fit Collar en la zona del tobillo
										que une la parte inferior de la pierna y el pie sin reducir la libertad de
										movimiento.</a></p>
							</div>
							<img alt="" src="<?= CLIENT_ASSETS ?>images/hot-deal.png" />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="ps-section__header mb-50">
				<div class="row">
					...
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
						<div class="ps-owl-actions"><a class="ps-prev" href="#">Prev</a><a class="ps-next"
								href="#">Next</a></div>
					</div>
				</div>
			</div>
			...
			<div class="ps-section__content">
				<div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-dots="false"
					...
					<div class="ps-shoes--carousel">
						...
						<div class="ps-shoe__content">
									<div class="ps-shoe__variants">
										<div class="ps-shoe__variant normal"><img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/2.jpg" /><img
												alt="" src="<?= CLIENT_ASSETS ?>images/shoe/3.jpg" /><img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/4.jpg" /><img
												alt="" src="<?= CLIENT_ASSETS ?>images/shoe/5.jpg" /></div>
										<select class="ps-rating ps-shoe__rating">
											<option value="1">1</option>
											<option value="1">2</option>
											<option value="1">3</option>
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									...
									<div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div>
									<img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/2.jpg" />
								</div>
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									<div class="ps-badge"><span>New</span></div>
									<img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/3.jpg" />
								</div>
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail"><img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/4.jpg" /></div>
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail">
									<div class="ps-badge"><span>New</span></div>
									<img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/5.jpg" />
								</div>
						...
						<div class="ps-shoes--carousel">
							<div class="ps-shoe">
								<div class="ps-shoe__thumbnail"><img alt="" src="<?= CLIENT_ASSETS ?>images/shoe/6.jpg" /></div>
		...
		<div class="container">
			<div class="owl-slider" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut" data-owl-auto="true"
				...
				<div class="ps-testimonial">
					<div class="ps-testimonial__thumbnail"><img alt="" src="<?= CLIENT_ASSETS ?>images/testimonial/1.jpg" /></div>
					...
					<footer>
						<p>&ldquo;Dessert pudding dessert jelly beans cupcake sweet caramels gingerbread. Fruitcake
							biscuit cheesecake. Cookie topping sweet muffin pudding tart bear claw sugar plum croissant.
							&ldquo;</p>
					</footer>
				</div>

				<div class="ps-testimonial">
					<div class="ps-testimonial__thumbnail"><img alt="" src="<?= CLIENT_ASSETS ?>images/testimonial/2.jpg" /></div>
				...
				<div class="ps-testimonial">
					<div class="ps-testimonial__thumbnail"><img alt="" src="<?= CLIENT_ASSETS ?>images/testimonial/3.jpg" /></div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
						<div class="ps-post">
							...
							<div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">Nike&rsquo;s
	...
	<div class="ps-home-partner">
		<div class="ps-container">
			<div class="owl-slider" data-owl-auto="true" data-owl-dots="false" data-owl-duration="1000"
				...
				data-owl-speed="5000"><a href="#"><img alt="" src="<?= CLIENT_ASSETS ?>images/partner/1.png" /></a><a href="#"><img alt=""
						src="<?= CLIENT_ASSETS ?>images/partner/2.png" /></a><a href="#"><img alt="" src="<?= CLIENT_ASSETS ?>images/partner/3.png" /></a><a
					href="#"><img alt="" src="<?= CLIENT_ASSETS ?>images/partner/4.png" /></a><a href="#"><img alt=""
						src="<?= CLIENT_ASSETS ?>images/partner/5.png" /></a><a href="#"><img alt="" src="<?= CLIENT_ASSETS ?>images/partner/6.png" /></a><a
					href="#"><img alt="" src="<?= CLIENT_ASSETS ?>images/partner/7.png" /></a><a href="#"><img alt=""
						src="<?= CLIENT_ASSETS ?>images/partner/8.png" /></a></div>
		</div>
	</div>
