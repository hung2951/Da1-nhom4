...
<head>
	...
	<link rel="stylesheet" href="<?= CLIENT_ASSETS ?>css/orders.css">
					...
					<div class="col-lg-6 col-md-4 col-sm-6 col-xs-12 ">
						<div class="header__actions"><a href="#">Login &amp; Regiser</a>
							...
							<div class="btn-group ps-dropdown"><a aria-expanded="false" aria-haspopup="true"
									class="dropdown-toggle" data-toggle="dropdown" href="#">USD</a>
							...
							<div class="btn-group ps-dropdown"><a aria-expanded="false" aria-haspopup="true"
									class="dropdown-toggle" data-toggle="dropdown" href="#">Language</a>
		...
		<nav class="navigation">
			<div class="container-fluid">
				<div class="navigation__column left">
					<div class="header__logo"><a class="ps-logo" href="index.html"><img alt=""
								src="<?= CLIENT_ASSETS ?>images/logo.png" /></a></div>
				</div>
				...
				<div class="navigation__column right">
					<form action="http://nouthemes.net/html/trueshoes/do_action" class="ps-search--header"
						method="post"><input class="form-control" placeholder="Search Product…"
							...
							<div class="ps-cart__content">
								<div class="ps-cart-item">
									...
									<div class="ps-cart-item__content"><a class="ps-cart-item__title"
											href="product-detail.html">Amazin&rsquo; Glazin&rsquo;</a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--info">
                        ...
                        <footer>
                            ...
                            <p>Email: <a
                                    href="http://nouthemes.net/cdn-cgi/l/email-protection#f98a8c8989968b8db98a8d968b9cd79a9694"><span
                                        class="__cf_email__"
                                        data-cfemail="7b080e0b0b14090f3b080f14091e55181416">[email&#160;protected]</span></a>
                            </p>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--info second">
                        ...
                        <footer>
                            ...
                            <p>Email: <a
                                    href="http://nouthemes.net/cdn-cgi/l/email-protection#cfbcbabfbfa0bdbb8fbcbba0bdaae1aca0a2"><span
                                        class="__cf_email__"
                                        data-cfemail="3f4c4a4f4f504d4b7f4c4b504d5a115c5052">[email&#160;protected]</span></a>
                            </p>
